package ne.cnss.authentificatiion.configuration;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeHttpRequests(authorization -> authorization
                        ...
                        .requestMatchers("/contact").permitAll() //ne nécessite pas une authentification pour être accessible
